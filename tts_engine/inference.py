...
DEFAULT_VOICE = "idk_female"  # Best voice according to documentation
...
def generate_tokens_from_api(prompt: str, voice: str = DEFAULT_VOICE, temperature: float = TEMPERATURE, 
    ...
    model_name = os.environ.get("ORPHEUS_MODEL_NAME", "urdu_female-Q8_0.gguf")
